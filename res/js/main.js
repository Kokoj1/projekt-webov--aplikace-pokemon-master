...
encharmander.onclick = () => {
    ...
    if (yourpok1 = 1) {
        ...
        hpbarlen = 100;
        yattdamhpbar1 = (damage1 / hpenemy * 100);
        yattdamhpbar2 = (damage2 / hpenemy * 100);
        yattdamhpbar3 = (damage3 / hpenemy * 100);
        yattdamhpbar4 = (damage4 / hpenemy * 100);
        yattdamhpbar5 = (damage5 / hpenemy * 100);
        enemydamage = (6 / hpenemy * 100);
        yourhp = 16;
        enemyattdamhpbar = (damageen / yourhp * 100);
...
move1.onclick = () => {
    ...
    setTimeout(function () {
        ...
        u = yourhpbarlen -= enemyattdamhpbar;
